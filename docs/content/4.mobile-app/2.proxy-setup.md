...
5. In the Sparky Fitness app, navigate to the settings screen and click on Server
6. Select your server from the list
7. Tap "Proxy Headers"
8. Enter in the header information that you copied from the Pangolin dashboard. You may need to click the + button to add another field.
